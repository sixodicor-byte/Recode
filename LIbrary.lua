...
local Library do
    ...
    local Keys = {
        ...
        ["KeypadMinus"]       = "KeypadMin",
        ["KeypadPlus"]        = "KeypadPlus",
        ["KeypadEnter"]       = "KeypadEnt",
        ["KeypadEquals"]      = "KeypadEq",
        ["Insert"]            = "Insert",
        ["Home"]              = "Home",
        ["PageUp"]            = "PageUp",
        ["PageDown"]          = "PageDown",
        ...
        function Keybind:Set(Key)
           ...
           elseif TableFind({"Toggle", "Hold", "Always"}, Key) then 
            ...
            elseif type(Key) == "table" then 
                ...
                local KeyString = Keys[Keybind.Key] or StringGSub(tostring(RealKey), "Enum.", "") or RealKey or "None"
    ...
    Library.Sections.Toggle = function(self, Data)
        ...
        function Toggle:Set(Bool)
            if Bool == nil then Bool = not Toggle.Value end
            Toggle.Value = Bool
